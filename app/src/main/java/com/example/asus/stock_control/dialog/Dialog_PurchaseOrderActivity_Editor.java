...
public class Dialog_PurchaseOrderActivity_Editor extends Dialog implements View.OnClickListener {
    ...
    public Dialog_PurchaseOrderActivity_Editor(@NonNull Context context, int editor) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_activity_editor_editor_purchaseorder);
