...
public class Dialog_PurchaseOrderActivity_Add extends Dialog implements View.OnClickListener {
    ...
    public Dialog_PurchaseOrderActivity_Add(@NonNull Context context, int editor) {
