...
public class Dialog_PurchaseOrderActivity_Delete extends Dialog implements View.OnClickListener {
    ...
    public Dialog_PurchaseOrderActivity_Delete(@NonNull Context context, int editor) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_activity_editor_delete_purchaseorder);
