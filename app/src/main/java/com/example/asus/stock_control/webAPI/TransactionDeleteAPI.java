...
import com.example.asus.stock_control.webService.TransactionDeleteServices;
...
public class TransactionDeleteAPI extends webapi{
    String url="http://123.207.36.208:8080/user/";
    Retrofit retrofit=getApi(url);

    @Override
    public <T> T getService() {
        return (T) retrofit.create(TransactionDeleteServices.class);
    }
}
