...
import com.example.asus.stock_control.webService.SupplierDeleteServices;
...
public class SupplierDeleteAPI extends webapi{
    String url="http://123.207.36.208:8080/user/";
    Retrofit retrofit=getApi(url);

    @Override
    public <T> T getService() {
        return (T) retrofit.create(SupplierDeleteServices.class);
    }
}
