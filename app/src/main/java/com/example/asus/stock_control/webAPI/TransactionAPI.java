...
import com.example.asus.stock_control.webService.TransactionServices;
...
public class TransactionAPI extends webapi{
    String url="http://123.207.36.208:8080/user/";
    Retrofit retrofit=getApi(url);

    @Override
    public <T> T getService() {
        return (T) retrofit.create(TransactionServices.class);
    }
}
