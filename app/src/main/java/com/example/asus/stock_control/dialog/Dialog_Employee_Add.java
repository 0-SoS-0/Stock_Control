...
public class Dialog_Employee_Add extends Dialog implements View.OnClickListener {
    ...
    public Dialog_Employee_Add(Context context) {
        super(context);
        this.context = context;
    }

    public Dialog_Employee_Add(@NonNull Context context, int editor) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_activity_editor_add_employee);
