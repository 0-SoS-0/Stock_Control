...
public class Dialog_Employee_Editor extends Dialog implements View.OnClickListener {
    ...
    public Dialog_Employee_Editor(Context context) {
        super(context);
        this.context = context;
    }

    public Dialog_Employee_Editor(@NonNull Context context, int editor) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_activity_editor_editor_employee);
