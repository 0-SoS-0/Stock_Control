...
public class Dialog_Employee_Delete extends Dialog implements View.OnClickListener {
    ...
    public Dialog_Employee_Delete(Context context) {
        super(context);
        this.context = context;
    }

    public Dialog_Employee_Delete(@NonNull Context context, int editor) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_activity_editor_delete_employee);
