...
import com.example.asus.stock_control.gsonbean.ProductEditorGsonBean;
...
public interface ProductEditorServices {
    @POST("")
    Call<ProductEditorGsonBean> getEmployeeAddServices(@Query("TableName") String Employee_info);
}
